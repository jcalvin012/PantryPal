...
const CATEGORY_RULES = [
  ['Snacks', ['snack', 'chocolate', 'candy', 'popcorn', 'nuts', 'peanuts', 'chips', 'crackers', 'biscuits', 'cookies', 'granola bar', 'protein bar', 'pretzel']],
  ...
  ['Canned', ['canned', 'can of', 'instant noodles', 'canned goods']],
